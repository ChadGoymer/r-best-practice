...
```{r data-import-cheatsheet, echo=FALSE, fig.align='center', fig.cap='Data Import', out.width='80%'}
knitr::include_graphics("images/data-import-cheatsheet-1.png")
# https://github.com/rstudio/cheatsheets/raw/master/data-import.pdf
```

```{r data-transformation-cheatsheet, echo=FALSE, fig.align='center', fig.cap='Data Transformation', out.width='80%'}
knitr::include_graphics("images/data-transformation-cheatsheet.png")
# https://github.com/rstudio/cheatsheets/raw/master/data-transformation.pdf
```

```{r strings-cheatsheet, echo=FALSE, fig.align='center', fig.cap='Strings', out.width='80%'}
knitr::include_graphics("images/strings.png")
# https://github.com/rstudio/cheatsheets/raw/master/strings.pdf
```

```{r lubridate-cheatsheet, echo=FALSE, fig.align='center', fig.cap='Dates and Times', out.width='80%'}
...
**Mutating joins**
 ...
 - [`right_join(x, y)`](http://dplyr.tidyverse.org/reference/join.html) includes all
   observations in `y`. It’s equivalent to 
