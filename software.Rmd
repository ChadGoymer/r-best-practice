...
are a number of ways to deal with this problem:
 ...
 2. Another approach is to create a site library, a location on a network drive where 
    ...
    1 and 2 can be combined to avoid installing packages every user.
 
 3. Use Microsoft's [`checkpoint`](https://mran.microsoft.com/documents/rro/reproducibility)
